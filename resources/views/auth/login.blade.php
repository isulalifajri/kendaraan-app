...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ $companyProfile->icon_url ?? asset('daun-icon.webp') }}" />
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo" style="width: 50px;height:50px">
                    <img src="{{ asset('no-images.jpg') }}" class="img-fluid rounded-circle h-100" alt="default">
                  </span>
                </a>
              </div>
              <!-- /Logo -->
